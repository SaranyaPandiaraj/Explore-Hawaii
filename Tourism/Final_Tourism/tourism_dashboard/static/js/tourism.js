...
function lengthstayplot(sample){
  ...
  for(var i =0;i<retrived.length;i++){
     ...
     if( retrived[i].Year == sample ) {
       ...
       kona.push(Math.round(retrived[i].Kona))
       Maui.push(Math.round(retrived[i].Maui))
       Hilo.push(Math.round(retrived[i].Hilo))
       Molokai.push(Math.round(retrived[i].Molokai))
       Kauai.push(Math.round(retrived[i].Kauai))
       Lanai.push(Math.round(retrived[i].Lanai))
       Oahu.push(Math.round(retrived[i].Oahu))
